<template>
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-2 text-base text-gray-400">
            <p><span class="font-semibold">Опыт:</span> {{ resume?.exp }}</p>
            <p><span class="font-semibold">Образование:</span> {{ resume?.education }}</p>
        </div>
        ...
        <div class="flex flex-col gap-4">
            <p class="text-2xl font-mono font-semibold">Информация о кандидате</p>
